...
2. The raw data we used for analyzing COVID-19 situation in terms of race is obtained from 'The COVID Tracking Project' ( https://covidtracking.com/race/about#download-the-data) and it contains the number of daily COVID-19 cases and deaths by race by US state from 2020-04-12 to 2021-03-07. We also get each state's overall population in 2020 from United States Census official website (link: https://www.census.gov/programs-surveys/popest/technical-documentation/research/evaluation-estimates.html).
