...
By doing this project, we learn to two things: First is to always believe in what our data show us no matter how counter-intuitive it is. Second is that the whole process of exploratory analysis and visualization is highly restricted to a huge extent by what the original/raw data are given no matter how hard we try in data cleaning and processing
